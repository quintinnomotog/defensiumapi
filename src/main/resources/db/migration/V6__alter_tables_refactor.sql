...
alter table tb_credencial add column cartao_bancario_numero_cartao char(14) null comment 'Número do Cartão Bancário para CARTAO_BANCARIO';
alter table tb_credencial add column cartao_bancario_data_validade char(5) null comment 'Data de validade do Cartão Bancário para CARTAO_BANCARIO';
alter table tb_credencial add column cartao_bancario_cvv char(3) null comment 'Código de Segurança do Cartão Bancário para CARTAO_BANCARIO';

alter table tb_credencial add column rede_nome varchar(60) null comment 'Nome da Rede para WI_FI';

alter table tb_credencial add column database_hostname varchar(60) null comment 'Host do Banco de Dados para BANCO_DE_DADOS';
alter table tb_credencial add column database_porta varchar(5) null comment 'Porta do Banco de Dados para BANCO_DE_DADOS';
alter table tb_credencial add column database_nome varchar(60) null comment 'Nome do Banco de Dados para BANCO_DE_DADOS';
